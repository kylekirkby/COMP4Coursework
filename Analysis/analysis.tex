...
\subsection{Areas considered for future computerisation}
	\begin{itemize}
		\item The collection of the measurements, which is currently being done manually, may be implemented using a space aware device which can scan a room and pick up the measurements of it using just a phone for example. This might be possible 
	\end{itemize}}
